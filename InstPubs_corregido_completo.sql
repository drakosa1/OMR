...
/* Verificación final de carga de datos */
USE pubs;
GO
SELECT 'authors' AS Tabla, COUNT(*) AS Total FROM authors
...
UNION ALL SELECT 'roysched', COUNT(*) FROM roysched
UNION ALL SELECT 'titleauthor', COUNT(*) FROM titleauthor;
GO
